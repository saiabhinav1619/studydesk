...
<div class="super_container">
	...
	<!-- Top Teachers -->
			...
			<div class="totalmain" style="margin-top: 100px; margin-left:10%; margin-right:10%;">
				<div >
					<h2 class="section_title text-center">Why You Are Getting This ?</h2>
				</div>
            <h1>May be the section existing in some other parallel universe</h1>
            <h1>OR</h1>
            <h1>Those are under development .</h1>
				...
				<div class="row">
					...
					<div class="col-lg-3 footer_col">
						<div class="newsletter_container d-flex flex-column align-items-start justify-content-end">
							<div class="footer_logo mb-auto"><a href="#">Royal Mech</a></div>
